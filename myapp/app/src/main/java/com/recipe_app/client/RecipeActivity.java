...
//     */
    ...
    private void handleIndent() {
        ...
        if(appLinkData != null) {
            ...
            Uri recipeUri = RecipeContentProvider.CONTENT_URI.buildUpon().appendPath(recipeId).build();
...
//        }
     ...
     */
    public static class RecipeFragment extends androidx.fragment.app.Fragment {
        /**
